...
{
  print_icmp_code (icmp->icmp_code, (char *)data);
...
struct icmp_diag icmp_diag[] = {
  {ICMP_ECHOREPLY, (char *)"Echo Reply", NULL},
  {ICMP_DEST_UNREACH, NULL, print_icmp, (void *)"Dest Unreachable"},
  {ICMP_SOURCE_QUENCH, "Source Quench", print_ip_data},
  {ICMP_REDIRECT, NULL, print_icmp, (void *)"Redirect"},
  {ICMP_ECHO, "Echo Request", NULL},
  {ICMP_TIME_EXCEEDED, NULL, print_icmp, (void *)"Time exceeded"},
