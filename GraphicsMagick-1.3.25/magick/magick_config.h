...
#define GM_BUILD_CC "clang"

/* CFLAGS used for C compilation */
#define GM_BUILD_CFLAGS "-g -O2 -Wall -pthread"

/* arguments passed to configure */
#define GM_BUILD_CONFIGURE_ARGS "./configure  'CC=clang' 'CXX=clang++' 'CXXFLAGS=-fsanitize=address -fsanitize-coverage=trace-pc-guard' 'LDFLAGS=-L/home/jake/git_stuff/LLVMdir/libFuzzer.a'"

/* CPPFLAGS used for preprocessing */
#define GM_BUILD_CPPFLAGS "-I/usr/include/libxml2"

/* C++ compiler used for compilation */
#define GM_BUILD_CXX "clang++"

/* CXXFLAGS used for C++ compilation */
#define GM_BUILD_CXXFLAGS "-fsanitize=address -fsanitize-coverage=trace-pc-guard -pthread"

/* Host identification triplet */
#define GM_BUILD_HOST "x86_64-unknown-linux-gnu"

/* LDFLAGS used for linking */
#define GM_BUILD_LDFLAGS "-L/home/jake/git_stuff/LLVMdir/libFuzzer.a"

/* LIBS used for linking */
#define GM_BUILD_LIBS "-lXext -lX11 -lxml2 -lz -lm -lpthread"
